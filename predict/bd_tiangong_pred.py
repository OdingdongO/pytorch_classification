...
train_root = "/media/hszc/model/detao/data/dianshi/宽波段数据集-预赛训练集2000/预赛训练集-2000"
...
rawdata_root =test_root if mode=="test" else train_root
...
resume = '/media/hszc/model/detao/models/bd_tiangong/resnet50/weights-26-80-[0.9917].pth'
